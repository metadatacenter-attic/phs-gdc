      ...
      <DialogContent>
        ...
        <DialogContentText>The Google-provided <a href="https://datacommons.org/">Data Commons repository</a> provides
          ...
          browseable by <a href="https://datacommons.org/place/">place</a> or <a
            ...
            href="http://docs.datacommons.org/tutorials">Python workbook examples</a>.</DialogContentText>
        <h3>The researchers</h3>
        <DialogContentText>Researchers in the Stanford PHS team, like all biomedical data researchers, must find,
          obtain, and
          ...
          of the PHS-Data Commons project.</DialogContentText>
        <h3>The developers</h3>
        <DialogContentText>The BMIR team brings its experience with research data and <a
          ...
          data and bring it into their own data sets.</DialogContentText>
        <h2>The Data Commons Wizard</h2>
        <DialogContentText>The <a href="https://dcw.metadatacenter.org">Data Commons Wizard prototype</a> provides a
          simple interface
          ...
          etc.) as the lookup index for the retrieved values.</DialogContentText>
        <DialogContentText>The result is a simple web interface that can provide data for most <a
          href="https://docs.datacommons.org/statistical_variables.html">Data Commons statistical variables</a> to
          researchers at any level, including non-technical users.</DialogContentText>
